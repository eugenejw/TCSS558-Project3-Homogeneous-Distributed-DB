...
class RPC_Client(cmd.Cmd):
    ...
    def do_QUERY(self, line):
        """QUERY [locally|globally]
        Query locally -- to query local DB
        Query globally -- to query all data on Distributed DBs"""

        os.system('python client_rpc.py QUERY %s'%line)
...
#   doing initial setup of ports, hostname, and instance
    print "\n"
    print "*** Welcome to TCSS558 Group7 Project3 *** \n"
    print "***                                    *** \n"    
